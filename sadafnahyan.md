...
```
scp "C:\Network OS\midterm\sadafnahyan.txt" pi@10.0.0.107:~
...
```
chmod 710 pr1.txt
(1- means group members can execute only)
```
...
```
creates mt.txt and saves folder structure to it. appends folder structure to pr.txt that was already created in task 2
```
...
```
1. sudo mkdir /home/sadafnahyaan
2.sudo chown sadafnahyaan:sadafnahyaan /home/sadafnahyaan (chown used to change ownership)
```
